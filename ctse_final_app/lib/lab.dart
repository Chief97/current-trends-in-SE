...
//                  _chip("Data Scientist", LightColor.lightBlue, height: 5),
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
            ...
            _courceInfo(CourseList.list[3], _decorationContainerB()),
            Divider(
              thickness: 1,
              endIndent: 20,
              indent: 20,
            ),
            _courceInfo(CourseList.list[4], _decorationContainerB()),
          ],
        ),
      ),
    );
  ...
  Widget _courceInfo(CourseModel model, Widget decoration) {
    return Container(
        height: 170,
        width: width - 20,
        child: Row(
